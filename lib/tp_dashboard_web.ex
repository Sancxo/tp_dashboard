  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: TpDashboardWeb.Layouts]
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: TpDashboardWeb.Router,
        statics: TpDashboardWeb.static_paths()
    end
  end
